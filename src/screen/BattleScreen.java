...
public class BattleScreen extends Screen {
    ...
    public BattleScreen(int width, int height, BattleManager battleManager) {
        super(width, height);
        ...
        battleOptions = new BattleOptions(battleManager, battleOptionsX, battleOptionsY, battleOptionsWidth, battleOptionsHeight);
        moveSelectBox = new MoveSelectBox(battleManager);
    }

    private void loadDimensions() {
        textBoxHeight = 220;
        textLocationX = 75;
        textLocationY = Game.HEIGHT - 125;
...
//        trainerPokemonY = 150;
        ...
        playerHudX = Game.WIDTH - 475;
        playerHudY = Game.HEIGHT - 220 - playerHudHeight - 10;
        ...
        battleOptionsX = Game.WIDTH - battleOptionsWidth;
        battleOptionsY = Game.HEIGHT - battleOptionsHeight;
    }
...
//        renderBattleBase(g);
    ...
    public void renderBackground(Graphics g) {
        g.drawImage(battleBackground, 0, 0, Game.WIDTH, Game.HEIGHT, null);
    }

    public void renderBattleBase(Graphics g) {
...
//        g.drawImage(battleBase, 660, 300, battleBase.getWidth()*4, battleBase.getHeight()*3, null);
    ...
    public void renderPokemon(Graphics g) {
    ...
    public void renderTextBox(Graphics g) {
        ...
        g.fillRect(0, Game.HEIGHT - 220, Game.WIDTH, textBoxHeight);

        g.setColor(new Color(46, 58, 67));
        g2d.setStroke(new BasicStroke(5));
        g.drawRect(0, Game.HEIGHT - 220, Game.WIDTH, textBoxHeight);
    }
    ...
    public void renderBattleOptions(Graphics g) {
        Font battleOptionFont = font.deriveFont(60f);
        g.setFont(battleOptionFont);
        battleOptions.render(g);
    }

    public void renderMoveSelectBox(Graphics g, Pokemon pokemon) {
