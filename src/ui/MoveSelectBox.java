...
public class MoveSelectBox {
    ...
    public MoveSelectBox(BattleManager battleManager) {
    ...
    private void loadDimensions() {
        ...
        moveOneX = 75;
        moveOneY = Game.HEIGHT - moveBoxHeight + 75;
        moveTwoX = 475;
        moveTwoY = Game.HEIGHT - moveBoxHeight + 75;
        moveThreeX = 75;
        moveThreeY = Game.HEIGHT - moveBoxHeight + 175;
        moveFourX = 475;
        moveFourY = Game.HEIGHT - moveBoxHeight + 175;
        ...
        infoBoxX = 800;
        infoBoxY = Game.HEIGHT - moveBoxHeight;
    }
    ...
    public void renderMoveBox(Graphics g, Pokemon pokemon) {
        ...
        g.fillRect(0, Game.HEIGHT - moveBoxHeight, 800, moveBoxHeight);

        g.setColor(Color.BLACK);
        g2d.setStroke(new BasicStroke(8));
        g.drawRect(0, Game.HEIGHT - moveBoxHeight, 800, moveBoxHeight);
